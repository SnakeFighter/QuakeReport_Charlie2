...
//Helper methods for our earthquake app.
...
public final class Utils {
    ...
    public static ArrayList <Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        //TODO change the below to return list of earthquakes.
        ArrayList meEarthquakes = new ArrayList <Earthquake>();
        meEarthquakes = QueryUtils.extractEarthquakes(jsonResponse);
    ...
    private static Earthquake extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            if (featureArray.length() > 0) {
                ...
                //TODO get rid of this sample return statement!
                return new Earthquake(12.0,"h",12,"h") ;
